...
const testimonials = [
  {
    quote: "Working with Supomelo transformed our product experience. The attention to detail and understanding of our users was exceptional.",
    name: 'Sarah Chen',
    role: 'CEO',
    company: 'TechStartup',
    duration: '6 MONTHS',
  ...
  {
    quote: "Finally, a designer who understands the pace of startups. Delivered incredible work while moving fast alongside our engineering team.",
    name: 'Marcus Johnson',
  ...
  {
    quote: "The design system they built has scaled beautifully as we've grown from 10 to 100+ features. Best investment we made.",
    name: 'Emily Park',
    role: 'CTO',
    company: 'ScaleUp',
    duration: '8 MONTHS',
...
export default function Testimonials() {
  ...
  return (
    <section id="work" className="py-20 lg:py-32 bg-bg-warm">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
        ...
        <motion.h2
          ...
          className="text-3xl md:text-4xl font-bold text-text-primary mt-6 mb-4"
        >
          Why supomelo?
        </motion.h2>
