...
export default function Navbar() {
  ...
  return (
    <>
      {/* Desktop Navbar - shows all items until md breakpoint */}
        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            ...
            <motion.div style={{ gap: navGap }} className="relative flex items-center">
              {/* Active section dot indicator - moved closer */}
              <motion.div
              ...
              {navLinks.map((link) => (
                <a
                  ...
                  className="group relative text-sm transition-colors cursor-pointer overflow-hidden"
                >
                  <span className="block transition-transform duration-300 group-hover:-translate-y-full">
                    {link.label}
                  </span>
                  <span className="absolute top-full left-0 block transition-transform duration-300 group-hover:-translate-y-full text-text-muted">
                    {link.label}
                  </span>
                </a>
              ))}
