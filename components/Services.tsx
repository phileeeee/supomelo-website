...
const services = [
  {
    title: 'UX Design',
    description: 'Research-led wireframes and flows that spark product discussion.',
  },
  {
    title: 'UI Design',
    description: 'Polished, dev-ready interfaces with accessibility baked in.',
  },
  {
    title: 'Design Systems',
    description: 'Scalable component libraries that grow with your product.',
  },
  {
    title: 'Prototyping',
    description: 'Interactive prototypes to validate ideas with real users.',
  },
  {
    title: 'AI Product Design',
    description: 'Intuitive AI-powered features and workflows for B2B.',
  },
  {
    title: 'User Research',
    description: 'Interviews and testing that inform smart design decisions.',
  },
];
