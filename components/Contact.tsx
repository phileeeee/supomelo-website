      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
        ...
        {isSubmitted ? (
          ...
          <motion.form
            ...
            className="max-w-2xl"
          >
            <div className="text-xl md:text-2xl text-text-light leading-relaxed space-y-4">
              <p className="flex flex-wrap items-center gap-2">
                ...
                <input
                  ...
                  } focus:border-accent outline-none px-2 py-1 text-text-light placeholder:text-text-muted/50 transition-colors min-w-[150px]`}
                />
              </p>
              ...
              <p className="flex flex-wrap items-center gap-2">
                ...
                <input
                  ...
                  className={`bg-transparent border-b-2 ${
                    errors.company ? 'border-red-400' : 'border-border-dark'
                  } focus:border-accent outline-none px-2 py-1 text-text-light placeholder:text-text-muted/50 transition-colors min-w-[150px]`}
                />
              </p>
                    ...
                    <motion.button
                      ...
                      className={`relative flex items-center gap-1.5 px-4 py-2 rounded-full text-base font-medium transition-colors cursor-pointer ${
                        isSelected
                          ...
                          : 'bg-card-dark text-text-light border border-border-dark hover:border-text-muted'
                      } ${errors.projectTypes && formData.projectTypes.length === 0 ? 'border-red-400' : ''}`}
                      whileTap={{ scale: 0.97 }}
                    >
              ...
              <p className="flex flex-wrap items-center gap-2">
                ...
                <input
                  ...
                  } focus:border-accent outline-none px-2 py-1 text-text-light placeholder:text-text-muted/50 transition-colors min-w-[200px]`}
                />
              </p>
            </div>
            ...
            <div className="mt-10">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                <span className="text-base font-medium text-white group-hover:text-bg-dark transition-colors duration-300">
                  Send message
                </span>
